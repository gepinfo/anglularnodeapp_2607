...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_anglularnodeapp_2607;
            let db_auth = result.data.DB_AUTH_anglularnodeapp_2607;
            let db_coll = result.data.DB_COLL_anglularnodeapp_2607;
