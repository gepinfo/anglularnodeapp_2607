...
{ path : 'empsave', loadChildren: () => import('./empsave/empsave.module').then(m => m.EmpsaveModule), canActivate: [AuthGuard] } , 
{ path : 'persave', loadChildren: () => import('./persave/persave.module').then(m => m.PersaveModule), canActivate: [AuthGuard] } , 
];
